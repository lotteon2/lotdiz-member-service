...
;             
CREATE USER IF NOT EXISTS "SA" SALT 'd3a72118ba3f8e63' HASH 'b92ab8bd87282001a0681916f2abd1bd555c3c53817bf2a418f513417eb2eed0' ADMIN;         
CREATE MEMORY TABLE "PUBLIC"."delivery_address"(
...
ALTER TABLE "PUBLIC"."delivery_address" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_1" PRIMARY KEY("delivery_address_id");            
...
ALTER TABLE "PUBLIC"."likes" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_6" PRIMARY KEY("member_id", "project_id");   
...
CREATE MEMORY TABLE "PUBLIC"."member"(
    ...
    "member_password" CHARACTER VARYING(16) NOT NULL,
...
ALTER TABLE "PUBLIC"."member" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_B" PRIMARY KEY("member_id");
...
ALTER TABLE "PUBLIC"."membership" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_B0" PRIMARY KEY("membership_id");       
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.membership;              
CREATE MEMORY TABLE "PUBLIC"."membership_policy"(
...
ALTER TABLE "PUBLIC"."membership_policy" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_61" PRIMARY KEY("membership_policy_id");         
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.membership_policy;       
CREATE MEMORY TABLE "PUBLIC"."membership_subscription"(
    "membership_subscription_id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) DEFAULT ON NULL NOT NULL,
    "created_at" TIMESTAMP,
    "updated_at" TIMESTAMP,
    "membership_id" BIGINT NOT NULL
);  
ALTER TABLE "PUBLIC"."membership_subscription" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_8" PRIMARY KEY("membership_subscription_id");              
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.membership_subscription; 
ALTER TABLE "PUBLIC"."member" ADD CONSTRAINT "PUBLIC"."UK_3orqjaukiw2b73e2gw8rer4rq" UNIQUE("member_email");  
ALTER TABLE "PUBLIC"."likes" ADD CONSTRAINT "PUBLIC"."FKa4vkf1skcfu5r6o5gfb5jf295" FOREIGN KEY("member_id") REFERENCES "PUBLIC"."member"("member_id") NOCHECK;
